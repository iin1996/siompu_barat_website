<div class="choose">
			...
			<div class="container">
				...
				<br><br><br>
				<?php
					$res = $pdo->query("SELECT COUNT(*) FROM potensi_desa WHERE potensidesa = 'PAKAIAN' AND id_desa = '$_GET[id]'");
				...
				<?php
					$inspiration = $pdo->query("SELECT * FROM potensi_desa WHERE potensidesa = 'PAKAIAN' AND id_desa = '$_GET[id]' ORDER BY id_potensi_desa DESC");
			...
			<?php } else { ?>
				<div class="alert alert-danger" role="alert" style="text-align: center;">
				 Desa ini tidak mempunyai pakaian
				</div>
			<?php } ?>
			</div>
			<!-- //container -->
