<div class="choose">
			...
			<div class="container">
				...
				<?php
					$inspiration = $pdo->query("SELECT * FROM wisata WHERE wisata = 'PEMANDIAN' ORDER BY id_wisata DESC");
				...
				?>
					<div class="col-md-4 choose-grid">
						...
						<div class="choose-button">
							<a href="detail-pemandian-<?php echo $gal['nama'];?>-<?php echo $gal['id_wisata'];?>">Selengkapnya</a>
						</div>
					</div>
					<?php } ?>
					<div class="clearfix"> </div>
