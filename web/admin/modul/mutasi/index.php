...
if (empty($_SESSION['namaadmin']) AND empty($_SESSION['leveladmin'])){
							...
							<tr>
							    ...
							    <td><?php echo  $rr['nama_dusun']; ?></td>
									...
									<table class="tbltmbahan" style="width: 100%;padding: 0px;min-height: 28px;text-align: center; border: 0px;">
										<tr>
											<!-- <td style="border-right: 2px solid #f4f4f4;"><a href="<?php echo $module; ?>-edit-<?php echo $r['id_mutasi']; ?>" title="Edit"><img src="add-icon.gif"><br/>Edit</a></td> -->
											
											<td style="border-right: 2px solid #f4f4f4;"><a title="Hapus" onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');" href='modul/<?php echo $module; ?>/aksi.php?module=<?php echo $module; ?>&act=remove&id=<?php echo $r['id_mutasi']; ?>' ><img src="hr.gif"><br/>Hapus</a>	</td>
										</tr>		
									</table>
								</td>
			  ...
			  <div class="row">
				...
				<div class="col-md-12">
				  ...
				  <div class="box box-primary">
					...
					<!-- form start -->
					<form role="form" action="mutasi-nik" method="POST" enctype="multipart/form-data" >
			  ...
			  <div class="row">
				...
				<div class="col-md-12">
				  ...
				  <div class="box box-primary">
					...
					<!-- form start -->
					<form role="form" action="modul/mutasi/aksi.php?module=<?php echo $module; ?>&act=add" method="POST" enctype="multipart/form-data" >
						...
						<div class="box-body table-responsive">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="exampleInputEmail1">Tujuan Mutasi <span title="wajib" style="color: red;">*</span></label>
									
										 <select class="form-control" name="tujuan_mutasi">
												 	<?php
														$mutasi = $pdo->query("SELECT * FROM dusun WHERE id_dusun != '$_POST[dusun]' ORDER BY nama_dusun ASC");
														while($m = $mutasi->fetch(PDO::FETCH_ASSOC)){
													?>
													   <option value="<?php echo $m['id_dusun'];?>"><?php echo $m['nama_dusun'];?></option>
													  <?php } ?>
									      </select> 
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="exampleInputEmail1">Tanggal Mutasi  <span title="wajib" style="color: red;">*</span></label>
									<input name="tanggal_mutasi" type="date" class="form-control" required="">
								</div>
							</div>
	...
	<?php
		break;
		case "edit":
		$edit = $pdo->query("SELECT * FROM mutasi WHERE id_mutasi ='$_GET[id]'");
